...
const ExtraDetailsSection: FC<IExtraDetailsSectionProps> = ({
  language,
  setLanguage,
  error,
  setTone,
  ...
  return (
    <section className="space-y-4">
      ...
      <ToneSection setTone={setTone} selectedTone={selectedTone} />
          ...
          >
            ...
            <span
              className={`ml-3 text-sm font-medium ${
                isImageEnabled ? "text-purple-700" : "text-gray-700"
              }`}
            >
